...
('Emergency', 'Emergency-related conversations', '["emergency","urgent","help","sos","crisis"]'::jsonb, 1),
('Support', 'General support inquiries', '["help","support","question","issue","problem"]'::jsonb, 2),
('Billing', 'Billing and payment related', '["billing","payment","invoice","charge","subscription"]'::jsonb, 3),
('Technical', 'Technical issues and bugs', '["bug","error","technical","app","login"]'::jsonb, 2),
('Sales', 'Sales and product inquiries', '["pricing","plan","purchase","buy","upgrade"]'::jsonb, 3);
