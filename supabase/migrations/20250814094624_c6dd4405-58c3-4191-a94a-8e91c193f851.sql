...
SET 
  ...
  features = ARRAY['Emergency SOS button', 'Family member alerts', 'Location sharing', 'Basic support'],
  is_popular = false,
  sort_order = 1
...
SET 
  ...
  features = ARRAY['All Family Connection features', 'AI health monitoring', '24/7 priority support', 'Advanced analytics', 'Multiple device support'],
  is_popular = true,
  sort_order = 2
...
INSERT INTO subscription_plans (
  ...
  'EUR',
  'month',
  ARRAY['All Premium features', 'Senior-specific health monitoring', 'Family dashboard access', 'Medical alert integration', 'Medication reminders', 'Fall detection'],
  true,
  false,
  3,
  now(),
