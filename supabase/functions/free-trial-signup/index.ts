...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    const userEmailResponse = await resend.emails.send({
      from: 'ICE SOS Lite <welcome@icesoslite.com>',
      to: [sanitizedEmail],
      ...
      html: `
        <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 600px; margin: 0 auto; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 0; color: white;">
          <div style="padding: 40px 30px; text-align: center;">
            <h1 style="color: white; margin: 0 0 20px 0; font-size: 28px;">Welcome to ICE SOS Lite!</h1>
          ...
          <div style="background: white; color: #333; padding: 40px 30px; margin: 0;">
            ...
            <p style="font-size: 16px; line-height: 1.6; margin: 0 0 25px 0;">
              Congratulations! Your 7-day free trial has been activated. You now have full access to all ICE SOS Lite premium features including:
            </p>
            ...
            <div style="text-align: center; margin: 30px 0;">
              <a href="https://icesoslite.com/register?trial=true&email=${encodeURIComponent(sanitizedEmail)}" 
            ...
            <p style="font-size: 16px; margin: 25px 0 0 0;">
              Best regards,<br>
              <strong>The ICE SOS Lite Team</strong>
            </p>
          </div>
    ...
    const adminEmailResponse = await resend.emails.send({
      from: 'ICE SOS Lite Trials <noreply@icesoslite.com>',
