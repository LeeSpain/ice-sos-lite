  ...
  return React.createElement('div', { style: { fontFamily: 'Arial, sans-serif', maxWidth: '600px', margin: '0 auto' } },
    ...
    React.createElement('div', { style: { padding: '30px' } },
      ...
      React.createElement('p', { style: { color: '#666', lineHeight: '1.6' } }, 
        'Thank you for choosing ICE SOS to keep your family safe. Our emergency response system is now active and ready to protect your loved ones 24/7.'
      ),
      ...
      React.createElement('div', { style: { textAlign: 'center', marginTop: '30px' } },
        React.createElement('a', { 
          href: 'https://ice-sos-lite.lovable.app/dashboard',
          style: {
    ...
    React.createElement('div', { style: { backgroundColor: '#f1f5f9', padding: '20px', textAlign: 'center', fontSize: '14px', color: '#666' } },
      'Need help? Contact our support team at support@ice-sos.com',
      React.createElement('br'),
      '© 2024 ICE SOS. Keeping families safe worldwide.'
    )
  );
};
...
const CampaignEmail = ({ 
  ...
  return React.createElement('div', { style: { fontFamily: 'Arial, sans-serif', maxWidth: '600px', margin: '0 auto' } },
    ...
    React.createElement('div', { style: { backgroundColor: '#f8fafc', padding: '20px', textAlign: 'center', fontSize: '12px', color: '#999' } },
      'You received this email because you subscribed to ICE SOS updates.',
      React.createElement('br'),
  ...
  try {
    ...
    switch (emailType) {
      case 'welcome':
        ...
        subject = `Welcome to ICE SOS, ${data.name}! 🛡️`;
        break;
      ...
      case 'campaign':
        htmlContent = await render(CampaignEmail({
          ...
          ctaUrl: data.ctaUrl || 'https://ice-sos-lite.lovable.app',
    ...
    const emailPromises = recipients.map(async (recipient: any) => {
      try {
        const result = await resend.emails.send({
          from: data.from || 'ICE SOS <noreply@ice-sos.com>',
          to: [recipient.email],
          subject: subject,
          html: htmlContent,
