                ...
                <div className="bg-muted/30 border rounded-lg p-4">
                  ...
                  <div className="bg-destructive/10 border border-destructive/20 rounded p-3 mb-3">
                    <p className="text-sm font-medium text-destructive">
                      ICE SOS Lite is NOT a replacement for emergency services
                    </p>
                  </div>
                ...
                <div className="grid gap-4 md:grid-cols-3">
                  <div className="border rounded-lg p-4">
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <p className="text-muted-foreground">dpo@icesoslite.com</p>
                      <p><strong>Privacy Rights:</strong></p>
                      <p className="text-muted-foreground">rights@icesoslite.com</p>
                    </div>
                  </div>
                  <div className="border rounded-lg p-4">
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <p className="text-muted-foreground">medical-privacy@icesoslite.com</p>
                      <p><strong>HIPAA Compliance:</strong></p>
                      <p className="text-muted-foreground">hipaa@icesoslite.com</p>
                    </div>
                  </div>
                  <div className="border rounded-lg p-4">
