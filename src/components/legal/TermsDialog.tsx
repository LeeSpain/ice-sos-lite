    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl h-[85vh] flex flex-col">
        <DialogHeader className="flex-shrink-0">
          ...
          <DialogDescription>
            Please read these terms carefully before using ICE SOS Lite emergency services.
          </DialogDescription>
        </DialogHeader>
            ...
            <ScrollArea className="h-full pr-4" onScrollCapture={handleScroll}>
              <div className="prose prose-sm max-w-none">
                ...
                <section id="acceptance" className="mb-8">
                  ...
                  <p className="mb-4">
                    By accessing, downloading, installing, or using ICE SOS Lite ("the Service"), you ("User," "you," or "your") 
                    agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, do not use the Service.
                  </p>
                  <p className="mb-4">
                    These Terms constitute a legally binding agreement between you and ICE SOS Lite ("Company," "we," "us," or "our"). 
                ...
                <section id="services" className="mb-8">
                  ...
                  <p className="mb-4">
                    ICE SOS Lite provides emergency response coordination services, including but not limited to:
                  </p>
                ...
                <section id="emergency" className="mb-8">
                  ...
                  <div className="bg-destructive/10 border border-destructive/20 rounded-lg p-4 mb-4">
                    ...
                    <p className="text-sm">
                      ICE SOS Lite is NOT a replacement for emergency services. In life-threatening situations, 
                ...
                <section className="mb-8">
                  ...
                  <p className="mb-4">
                    ...
                    <a href="mailto:icesoslite@gmail.com" className="text-primary hover:underline ml-1">
