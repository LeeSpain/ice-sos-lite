...
const businessInfo: BusinessInfo = {
  ...
  partnerships: {
    ...
    contact: "partnerships@icesoslite.com",
    criteria: [
  ...
  integration: {
    ...
    webhooks: true,
    documentation: "https://icesoslite.com/api-docs"
  },
  contact: {
    business: "business@icesoslite.com",
    partnerships: "partnerships@icesoslite.com", 
    ai_collaboration: "ai-partnerships@icesoslite.com",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Corporation",
            "@id": "https://icesoslite.com/#corporation",
