...
const AIBusinessProfile: React.FC<AIBusinessProfileProps> = ({ className = '' }) => {
  const businessData = {
    ...
    '@type': 'Organization',
    '@id': 'https://icesoslite.com/#organization',
    'name': 'ICE SOS Lite',
    'alternateName': ['ICE SOS Emergency Protection', 'Emergency Protection Services'],
    ...
    'logo': {
      '@type': 'ImageObject',
      'url': 'https://icesoslite.com/logo.png',
      'width': 400,
      'height': 400
    },
    ...
    'sameAs': [
      ...
      'https://instagram.com/icesoslite'
    ],
