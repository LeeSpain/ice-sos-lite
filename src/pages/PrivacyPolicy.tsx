      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <div className="prose prose-lg dark:prose-invert max-w-none">
          ...
          <section id="introduction" className="mb-8">
            ...
            <p className="mb-4">
              ICE SOS ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our emergency response platform.
            </p>
            <div className="bg-amber-50 dark:bg-amber-900/20 border-l-4 border-amber-500 p-4 mb-4">
              <p className="font-semibold mb-2">IMPORTANT: ICE SOS is an emergency assistance platform.</p>
          ...
          <section id="data-retention" className="mb-8">
            ...
            <p className="bg-blue-50 dark:bg-blue-900/20 border-l-4 border-blue-500 p-4">
              ...
              <a href="mailto:privacy@icesos.com" className="text-blue-600 dark:text-blue-400 underline">
                privacy@icesos.com
              </a>
          ...
          <section id="your-rights" className="mb-8">
            ...
            <p className="bg-green-50 dark:bg-green-900/20 border-l-4 border-green-500 p-4">
              ...
              <a href="mailto:privacy@icesos.com" className="text-green-600 dark:text-green-400 underline">
                privacy@icesos.com
              </a>{' '}
            ...
            <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-6 space-y-4">
              <div>
                ...
                <ul className="space-y-1 text-sm">
                  <li>Email: <a href="mailto:privacy@icesos.com" className="text-blue-600 dark:text-blue-400 underline">privacy@icesos.com</a></li>
              ...
              <div>
                ...
                <p className="text-sm mt-1">Contact: <a href="mailto:privacy@icesos.com" className="text-blue-600 dark:text-blue-400 underline">privacy@icesos.com</a></p>
              </div>
              ...
              <div>
                ...
                <p className="text-sm mt-1">Contact: <a href="mailto:dpo@icesos.com" className="text-blue-600 dark:text-blue-400 underline">dpo@icesos.com</a></p>
              </div>
            </div>
          </section>
          ...
          <section id="emergency-disclosure" className="mb-8">
            <div className="bg-red-50 dark:bg-red-900/20 border-2 border-red-500 rounded-lg p-6">
              ...
              <p className="text-sm">
                This is necessary for our legitimate interest in preserving life. By using ICE SOS, you acknowledge and consent to this emergency disclosure practice.
              </p>
            </div>
          </section>
          ...
          <div className="mt-12 pt-8 border-t border-gray-200 dark:border-gray-700 text-center text-sm text-gray-600 dark:text-gray-400">
            <p className="mb-2">
              <strong>ICE SOS is committed to transparency and protecting your privacy while ensuring effective emergency response.</strong>
            </p>
