...
const RegistrationSuccess = () => {
  ...
  // App Store URLs
  const iosAppStoreUrl = 'https://apps.apple.com/app/ice-sos-lite/id123456789';
  const androidPlayStoreUrl = 'https://play.google.com/store/apps/details?id=com.icesos.lite';
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <Card className="bg-white/95 backdrop-blur-sm shadow-2xl border-0 mb-8">
            <CardHeader className="text-center">
              <CardTitle className="text-2xl font-bold flex items-center justify-center gap-3">
                ...
                Download Your ICE SOS Lite App
              </CardTitle>
              ...
              <div className="mt-8 p-6 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border border-blue-200">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Button variant="outline" asChild>
                    <a href={`sms:?body=Download ICE SOS Lite: ${iosAppStoreUrl}`}>
                      📲 Text iOS link to phone
                    </a>
                  </Button>
                  <Button variant="outline" asChild>
                    <a href={`sms:?body=Download ICE SOS Lite: ${androidPlayStoreUrl}`}>
          ...
          <div className="text-center mt-8 p-6 bg-white/80 rounded-xl">
            ...
            <div className="flex flex-wrap justify-center gap-4 text-sm">
              <a href="mailto:support@icesos.com" className="text-primary hover:underline">
                📧 support@icesos.com
              </a>
