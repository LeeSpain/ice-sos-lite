      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <div className="prose prose-lg dark:prose-invert max-w-none">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="font-semibold mb-2">
                  ICE SOS is a supplementary emergency coordination platform. It is NOT a replacement for official emergency services (911, 112, etc.).
                </p>
                <p className="text-sm">
          ...
          <section id="acceptance" className="mb-8">
            ...
            <p className="mb-4">
              By accessing or using ICE SOS ("Service," "Platform," "we," "us," or "our"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, do not use the Service.
            </p>
          </section>
          ...
          <section id="service-description" className="mb-8">
            ...
            <h3 className="text-xl font-semibold mb-3">ICE SOS provides:</h3>
          ...
          <section id="emergency-services" className="mb-8">
            ...
            <div className="bg-red-50 dark:bg-red-900/20 border-l-4 border-red-500 p-4 mb-4">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>Rely solely on ICE SOS in true emergencies</li>
          ...
          <section id="indemnification" className="mb-8">
            ...
            <p className="mb-4">
              You agree to indemnify and hold harmless ICE SOS, its officers, directors, employees, and agents from any claims, damages, or expenses arising from:
            </p>
            <ul className="list-disc pl-6 mb-4 space-y-2">
          ...
          <section id="governing-law" className="mb-8">
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 border-l-4 border-blue-500 p-4 mb-4">
              ...
              <p className="font-semibold mb-2">
                IMPORTANT: YOU AND ICE SOS AGREE TO RESOLVE DISPUTES THROUGH BINDING ARBITRATION, NOT COURT LITIGATION.
              </p>
          ...
          <section id="contact" className="mb-8">
            ...
            <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-6 space-y-4">
              <div>
                ...
                <p className="text-sm">Email: <a href="mailto:legal@icesos.com" className="text-blue-600 dark:text-blue-400 underline">legal@icesos.com</a></p>
              </div>

              <div>
                <h3 className="font-semibold mb-2">Customer Support:</h3>
                <p className="text-sm">Email: <a href="mailto:support@icesos.com" className="text-blue-600 dark:text-blue-400 underline">support@icesos.com</a></p>
              </div>
            </div>
          </section>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="font-semibold mb-3">
                    ICE SOS is a coordination tool, NOT a replacement for emergency services.
                  </p>
                  <div className="bg-white dark:bg-gray-900 rounded p-4 mb-3">
                    ...
                    <ol className="list-decimal pl-6 space-y-1 text-sm">
                      ...
                      <li>Then use ICE SOS to notify your contacts</li>
          ...
          <section id="final-acceptance" className="mb-8">
            <div className="bg-gray-100 dark:bg-gray-800 rounded-lg p-6">
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>You understand ICE SOS is NOT a replacement for 911/112</li>
          ...
          <div className="mt-12 pt-8 border-t border-gray-200 dark:border-gray-700 text-center text-sm text-gray-600 dark:text-gray-400">
            <p className="mb-2 font-semibold">
              ICE SOS - Empowering emergency coordination, not replacing emergency services.
            </p>
            <p>© 2026 ICE SOS. All rights reserved.</p>
          </div>
        </div>
      </div>
    </div>
