            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                  Living in Spain as an expat or visiting for travel can be challenging when an emergency arises. In urgent situations, clear communication is essential — but language barriers often add unnecessary stress. With ICE SOS Lite, you are never alone. Our Spain Regional Emergency Support team provides professional, bilingual assistance to ensure that you receive help quickly, your needs are understood, and your family is kept informed every step of the way.
                </p>
              </div>
              <div className="relative">
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="bg-gradient-to-r from-primary/20 to-wellness/20 rounded-2xl p-8 border-2 border-primary/30">
                <h3 className="text-2xl font-bold mb-4">Ready to Join ICE SOS Lite?</h3>
