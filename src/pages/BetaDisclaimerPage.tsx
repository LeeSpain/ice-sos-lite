      ...
      <div className="max-w-4xl mx-auto space-y-6">
        <div className="text-center space-y-4">
          <Badge variant="secondary" className="bg-amber-100 text-amber-800 text-lg px-4 py-2">
            ...
            ICE SOS LITE - BETA VERSION
          </Badge>
          <h1 className="text-4xl font-bold">Welcome to Our Beta Program</h1>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            You're about to join the exclusive beta launch of ICE SOS Lite. Please read the following important information.
          </p>
        </div>
